...
void XsheetPanel::setSheet(const QStringList& celNames, const QList<QList<int>>& exposures, int frameCount,
                            int currentFrame, int activeCel) {
    m_updating = true;
    ...
    m_table->setHorizontalHeaderLabels(celNames);
