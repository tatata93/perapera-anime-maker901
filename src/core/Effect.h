...
// 撮影エフェクトの種類
// ColorCorrect以降は後から追加した6種(ppamはint保存のため既存値の後ろに追加し、順序は変えない)
enum class EffectType { Blur, Glow, Para, Shake, ColorCorrect, Diffusion, RadialBlur, Vignette, Grain, ChromAb };
