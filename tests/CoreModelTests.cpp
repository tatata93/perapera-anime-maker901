...
TEST_CASE("Previz scene round trips through ppam", "[core][previz][io]") {
    ...
    model.humanoidBody.bellyHeight = 1.18f;
    model.humanoidBody.chestWidth = 1.25f;
    model.humanoidBody.chestDepth = 0.82f;
    model.humanoidBody.armLength = 1.40f;
    model.humanoidBody.armDepth = 0.75f;
    model.humanoidBody.legThickness = 0.70f;
    model.humanoidBody.footScale = 1.30f;
    model.humanoidBody.footDepth = 1.22f;
    model.humanoidBody.leftArmLength = 1.20f;
    model.humanoidBody.rightArmThickness = 0.65f;
    model.humanoidBody.leftLegLength = 0.85f;
    model.humanoidBody.rightFootScale = 1.45f;
    model.humanoidBody.leftUpperArmLength = 1.33f;
    model.humanoidBody.rightForearmThickness = 0.77f;
    model.humanoidBody.leftThighDepth = 1.44f;
    model.humanoidBody.rightShinLength = 0.68f;
    ...
    REQUIRE(previz.models[0].humanoidBody.headWidth == 1.12f);
    REQUIRE(previz.models[0].humanoidBody.faceDepth == 1.35f);
    REQUIRE(previz.models[0].humanoidBody.bellyHeight == 1.18f);
    REQUIRE(previz.models[0].humanoidBody.chestWidth == 1.25f);
    REQUIRE(previz.models[0].humanoidBody.chestDepth == 0.82f);
    REQUIRE(previz.models[0].humanoidBody.armLength == 1.40f);
    REQUIRE(previz.models[0].humanoidBody.armDepth == 0.75f);
    REQUIRE(previz.models[0].humanoidBody.legThickness == 0.70f);
    REQUIRE(previz.models[0].humanoidBody.footScale == 1.30f);
    REQUIRE(previz.models[0].humanoidBody.footDepth == 1.22f);
    REQUIRE(previz.models[0].humanoidBody.leftArmLength == 1.20f);
    REQUIRE(previz.models[0].humanoidBody.rightArmThickness == 0.65f);
    REQUIRE(previz.models[0].humanoidBody.leftLegLength == 0.85f);
    REQUIRE(previz.models[0].humanoidBody.rightFootScale == 1.45f);
    REQUIRE(previz.models[0].humanoidBody.leftUpperArmLength == 1.33f);
    REQUIRE(previz.models[0].humanoidBody.rightForearmThickness == 0.77f);
    REQUIRE(previz.models[0].humanoidBody.leftThighDepth == 1.44f);
    REQUIRE(previz.models[0].humanoidBody.rightShinLength == 0.68f);
